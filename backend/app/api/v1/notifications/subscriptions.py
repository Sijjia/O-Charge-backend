...
@router.post("/subscribe", response_model=SubscriptionResponse, summary="Subscribe to push notifications", description="Registers a Web Push subscription endpoint for the authenticated user.", responses=AUTH_RESPONSES)
...
@router.post("/unsubscribe", response_model=SubscriptionResponse, summary="Unsubscribe from push notifications", description="Removes a Web Push subscription endpoint.", responses=AUTH_RESPONSES)
...
@router.post("/test", response_model=dict, summary="Send test push notification", description="Sends a test push notification to all subscriptions of the authenticated user.", responses=AUTH_RESPONSES)
    ...
    **Возвращает:**
    ...
    try:
        ...
        result = await push_service.send_notification(
            ...
            body="This is a test push notification from RedPetroleum",
            icon="/logo-192.png",
            data={
                "type": "test",
