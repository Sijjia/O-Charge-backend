...
@router.get(
    ...
    description="Returns all charging locations with station counts and availability. Optionally includes full station data.",
)
...
@router.get(
    ...
    description="Returns detailed information about a specific location including stations and connectors.",
)
...
@router.post(
    "/locations/{location_id}/refresh-status",
    summary="Refresh location status",
    description="Recalculates station and connector availability counts for a location.",
)
